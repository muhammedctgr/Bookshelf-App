...
In this project, I learned how to extend Flask Microframework so that I can:
...
``` pip3 install -r requirements.txt ``` || some might need upgrading, you can do that
``` using pip3 install --upgrade ``` followed by what needs upgarding i.e ``` pip3 install --upgrade Flask-Cors ```
